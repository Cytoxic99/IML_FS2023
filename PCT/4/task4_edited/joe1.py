...
class CustomModel(TransformerMixin, BaseEstimator):
    def __init__(self, pretrained_weights_path):
        self.pretrained_weights_path = pretrained_weights_path
        self.model = None

    def fit(self, X, y=None):
        # Load the pretrained weights and initialize your model
        self.model = torch.load(self.pretrained_weights_path)
        self.model = model()
        return self

    def transform(self, X):
        # Perform the desired transformation using your model
        transformed_data = self.model.predict(X)
        return transformed_data

    def predict(self, X):
        # Forward the input through the neural network and return predictions
...
def get_regression_model():
    ...
    model = CustomModel('model_full.pth')
    return model
...
if __name__ == '__main__':
    ...
    pipeline = Pipeline([
        ...
        ("regression", CustomModel(pretrained_weights_path='model_full.pth'))
    ])
