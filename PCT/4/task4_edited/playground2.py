...
if __name__ == '__main__':
    ...
    epochen = 2
    mischen = False
    make_feature_extractor(x_pretrain, y_pretrain, batsch_size,
                                                 n_eval, learning_rate, num_arbeiter, mischen, epochen)
    print('model generated')

    # extract features from the 100 molecules in the training data
    pretrained_features = make_features(x_train)
    ...
    PretrainedFeatureClass(feature_extractor=)
